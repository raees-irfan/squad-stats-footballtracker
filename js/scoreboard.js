...
function mvpMiniCardHtml(match){
  ...
  return `
    <div style="background:rgba(0,0,0,0.28); border:1px solid var(--amber); border-radius:8px; padding:8px 12px; margin-top:10px; text-align:left;">
      <div style="text-align:center; font-size:10px; color:var(--amber); font-weight:700; letter-spacing:0.04em; margin-bottom:6px;">🏆 MATCH MVP</div>
      <div style="display:flex; align-items:center; gap:10px;">
        ...
        <div style="flex:1; min-width:0;">
          ...
          ${pr.bio ? `<div style="font-size:11px; color:rgba(233,238,242,0.55); font-style:italic; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">"${escapeHtml(pr.bio)}"</div>` : ''}
        </div>
